...
<form action="<?php echo base_url('admin/partners/tambah') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-4">
    ...
    <div class="form-group">
        ...
        <input type="text" name="sertifikat" class="form-control" placeholder="Sertifikat"  value="<?php echo set_value('sertifkat') ?>">
    </div>    
