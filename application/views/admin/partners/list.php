...
<p><a href="<?php echo base_url('admin/partners/tambah') ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Partners</a></p>
...
<!-- End Modals-->
        ...
        <a href="<?php echo base_url('admin/partners/edit/'.$staff->id_staff) ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>
...
<div class="modal-dialog">
  <div class="modal-content">
      <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title" id="myModalLabel">Yeskin ingin menghapus staff ini?</h4>
      </div>
      <div class="modal-body">
      <div class="col-md-12">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>
    <a href="<?php echo base_url('admin/partners/delete/'.$staff->id_staff) ?>" class="btn btn-primary btn-sm">Delete Staff</a>
