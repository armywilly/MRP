	...
	<div class="form-group input-group-lg">
        ...
        <div class="form-group">
            ...
            <select name="status" class="form-control">
              ...
              <?php if($product['status']=="publish") { echo "selected"; } ?>
              >Publish</option>}

              <option value="draft" 
              <?php if($product['status']=="draft") { echo "selected"; } ?>
              >Draft</option>}                
        ...
        <input type="number" name="urutan" class="form-control" value="<?php echo $product['urutan'] ?>" placeholder="Urutan tampil">
    </div>
    <div class="form-group">
        <label>Descriptioon</label>
        <textarea name="product_description" placeholder="Product Description" id="isi" class="form-control"><?php echo $product['product_description'] ?></textarea>
    </div>                              
</div>
<div class="col-md-12">
<div class="form-group">
