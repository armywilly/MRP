...
<ul class="nav" id="main-menu">
    ...
    <li><a href="#"><i class="fa fa-user-md"></i> Partners<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/partners') ?>">List Partners</a></li>
            <li><a href="<?php echo base_url('admin/partners/tambah') ?>">Create Partners</a></li>
        </ul>
    </li>
    <li><a href="#"><i class="fa fa-user-md"></i> Associates<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/associates') ?>">List Associates</a></li>
            <li><a href="<?php echo base_url('admin/associates/tambah') ?>">Create Associates</a></li>
        </ul>
    </li> 

    <li><a href="#"><i class="fa fa-list"></i> Practice Areas<span class="fa arrow"></span></a>
        <ul class="nav nav-second-level">
            <li><a href="<?php echo base_url('admin/products') ?>">List Practice Areas</a></li>
            <li><a href="<?php echo base_url('admin/products/create') ?>">Create Practice Areas</a></li>
        </ul>
    </li> 
