...
<div class="col-md-6">
    <h3>Notice</h3><hr>
    <div class="alert alert-warning"><label>Important</label><hr>Silahkan cantumkan alamat sosial media yang valid <br> Contohnya seperti <i>https://facebook.com/(Nama FB Kalian)</i>. <br> Karena fitur ini di integrasikan langsung menggunakan API Server.<br><br>Jika terjadi kesulitan anda dapat menghubungi contact : <i>muhammadarmy14@gmail.com</i></div>
</div>
