...
<div class="panel panel-primary text-center no-boder bg-color-gray">
    <div class="panel-body">
        ...
        <h3><?php echo $products ?> Practice Areas </h3>
    </div>
    <div class="panel-footer back-footer-white putih">
    <a href="<?php echo base_url()?>admin/products">Management Practice Areas</a>
    </div></div></div>
...
<div class="panel panel-primary text-center no-boder bg-color-gray">
    <div class="panel-body">
        <i class="fa fa-user fa-5x"></i>
        <h3><?php echo $associates ?> Associates </h3>
    </div>
    <div class="panel-footer back-footer-white putih">
    <a href="<?php echo base_url()?>admin/associates">Management Associates</a>
    </div></div></div>     
...
<div class="panel panel-primary text-center no-boder bg-color-gray">
    <div class="panel-body">
        <i class="fa fa-user fa-5x"></i>
        <h3><?php echo $partners ?> Partners </h3>
    </div>
    <div class="panel-footer back-footer-white putih">
    <a href="<?php echo base_url()?>admin/partners">Management Partners</a>
    </div></div></div>      
